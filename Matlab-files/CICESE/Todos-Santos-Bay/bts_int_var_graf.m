...
% (Load interpolation matrices of hydrographic variables of BTS's campaigns
% on its interior region. Makes temperature/salinity diagrams, transverse 
% sections and horizontal fields.)
...
%% (Load bathymetry and coast line files)
% linea de costa
