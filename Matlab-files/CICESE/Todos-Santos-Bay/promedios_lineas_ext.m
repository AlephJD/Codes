...
% (Makes spacial/time averages/anomalies calculations on sample lines for
% BTS's cruises.)
...
for cruc = 1:m
    for linea = 1:n
        ...
        % (Matrix is restricted to 1000 dbar level.)
...
%% (Local Basic stats and anomalies.)
for linea = 1:n
...
%% (Seasonal basic stats and anomalies)
for linea = 1:n
%%%%%%%%%%%%%%%%% INVIERNO %%%%%%%%%%%%%%%    
